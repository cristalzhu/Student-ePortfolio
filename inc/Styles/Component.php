...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	protected function get_css_files() : array {
		...
		$css_files = array(
			'wp-rig-carousel'    => array(
				'file'             => 'carousel.min.css',
			...
			'wp-rig-hpfooter' => array(
				'file' => 'hpfooter.min.css',
				'global' => true,
			),
	...
	protected function get_google_fonts() : array {
		...
		$google_fonts = array(
			'Merriweather'     => array( '400', '400i', '600', '600i' ),
			'Open Sans'     => array( '400', '400i', '600', '600i')
		);
